  ...
  <div class="main-coupon-details">
    ...
    <div class="footer-coupon-details">
      <div class="btn-footer-coupon-details" @click="openModal(1)">
        ...
        <span class="sub-title-btn">（店舗QRコード読み取り画面へ）</span>
      </div>
    </div>
    <ModalCouponDetails v-model="useCoupon" />
    <ModalAnimationCouponDetails v-model="isModalAnimation" />
    <ScanQrCoupon v-model="isModalScaner" @update:modelValue="useCoupon = $event" />
  </div>
</template>

<script lang="ts" setup>
import ModalCouponDetails from '@/components/ModalCouponDetails.vue'
import ModalAnimationCouponDetails from '@/components/ModalAnimationCouponDetails.vue'
import ScanQrCoupon from '@/views/ScanQrCoupon.vue'
import { ref } from 'vue'
